...
<template>
    <div class="d-flex justify-content-between w-100 container p-2 bg-secondary border border-0 rounded align-items-center">
        ...
        <div class="d-flex" style="font-size: 13px">
            ...
            <button class="filtroResponsivo bg-transparent border border-0" data-bs-target="#exampleModalToggle3" data-bs-toggle="modal">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body justify-content-center">
                    <h1 class="modal-title fs-5 mb-3" id="exampleModalToggleLabel">Filtrar tarefas</h1>
                    <input class="form-control mb-3" type="text" placeholder="Data prevista conclusao" aria-label="default input example" v-model="model.dataConclusao">
                    <input class="form-control mb-3" type="text" placeholder="Data conclusao final" aria-label="default input example" v-model="model.dataConlusaoFinal">
                    ...
                    <div class="d-flex justify-content-center">
                        <button class="btn btn-primary border-0" data-bs-target="#exampleModalToggle3" data-bs-toggle="modal" v-on:click="enviar()">Salvar</button>
